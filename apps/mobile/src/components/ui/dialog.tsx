...
const FullWindowOverlay =
  Platform.OS === "ios" && typeof RNFullWindowOverlay !== "undefined"
    ? (RNFullWindowOverlay as unknown as React.ComponentType<{
    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          className={cn(
            "bg-card border-border z-50 mx-auto flex w-full flex-col gap-4 rounded-lg border p-6 shadow-lg shadow-black/5 sm:max-w-lg",
            Platform.select({
